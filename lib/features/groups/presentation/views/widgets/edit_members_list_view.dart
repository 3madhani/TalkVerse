...
class EditMembersListView extends StatefulWidget {
  final GroupEntity? group;

  const EditMembersListView({super.key, this.group});

  @override
  State<EditMembersListView> createState() => _EditMembersListViewState();
}

class _EditMembersListViewState extends State<EditMembersListView> {
  @override
